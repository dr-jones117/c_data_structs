...
void run_int_vector_tests() {
    ...
    push_back(vec, allocate_int(12));

    assert(vector_is_empty(vec) == false);
    assert(vector_size(vec) == 1);
    assert(*(int*)vector_at(vec, 0) == 12);

    push_back(vec, allocate_int(52));
    push_back(vec, allocate_int(26));
    push_back(vec, allocate_int(828371));
    ...
    push_back(vec, allocate_int(213));
    assert(*(int*)vector_at(vec, 4) == 213);

    push_back(vec, allocate_int(-13));
    assert(*(int*)vector_at(vec, 5) == -13);
    push_back(vec, allocate_int(1000));
    ...
    */
    ...
    assert(**(int**)vector_end(vec) == 1000);

    pop_back(vec);
    pop_back(vec);
    pop_back(vec);

    assert(**(int**)vector_end(vec) == 828371);
    assert(vector_size(vec) == 4);
